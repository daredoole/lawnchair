...
public class TransitionUtil {
    ...
    // LC-Note: TransitionInfo#getChanges is a hidden API whose descriptor has drifted across
    // Android 16 builds in the field; a direct call throws NoSuchMethodError on affected
    // devices, which previously took down every transition-ordering/layering computation in
    // this file (hasDisplayChange, isAllOrderOnly, setupLeash, etc.) with it. Reach for it
    // reflectively and degrade to an empty change list rather than crashing.
