...
class TaskbarInsetsController(val context: TaskbarActivityContext) : LoggableTaskbarController {
    ...
    companion object {
        ...
        // LC-Note: InsetsFrameProvider's setSource/setFlags/setInsetsSize/setInsetsSizeOverrides
        // are hidden APIs whose exact signatures (and, on some builds, existence) have drifted
        // across Android 16 framework builds in the field. The direct calls this file used to
        // make throw NoSuchMethodError on affected devices, breaking taskbar inset reporting
        // entirely. Reach for each setter reflectively with a same-purpose fallback rather than
        // crashing when a given build doesn't expose the signature this code was compiled
        // against.
