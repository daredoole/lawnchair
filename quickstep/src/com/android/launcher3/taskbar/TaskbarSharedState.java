...
public class TaskbarSharedState {
    ...
    // LC-Note: InsetsFrameProvider#setSource(int) is a hidden API whose exact signature has
    // drifted across Android 16 builds in the field. Reach for it reflectively and fall back
    // to the no-arg overload (or leave the provider unmodified) rather than crashing on
    // NoSuchMethodError when a given build doesn't expose the signature this code was
    // compiled against.
