...
public class RecentTasksList {
    ...
    TaskLoadResult loadTasksInBackground(int numTasks, int requestId, boolean loadKeysOnly) {
        ...
        // LC-Note: some Android 16 builds' Shell/ATM implementations can hand back a
        // GroupedTaskInfo entry that is null, or whose getBaseGroupedTask() throws or returns
        // null (a malformed/partially-torn-down task record). The un-guarded field/method
        // access below crashed recents-list construction entirely on affected devices --
        // one bad entry took down the whole Overview/taskbar-recents list. Skip just the
