...
public class RemoteAnimationTargetCompat {
    ...
    private static RemoteAnimationTarget[] wrap(TransitionInfo info,
        ...
        // LC-Note: TransitionInfo#getChanges is a hidden API whose descriptor has drifted
        // across Android 16 builds in the field; a direct call throws NoSuchMethodError on
        // affected devices. Use TransitionUtil.getChanges(info), which tries the known
        // descriptors via reflection instead of calling the hidden API directly.
