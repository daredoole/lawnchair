...
// LC-Note: IRemoteTransitionFinishedCallback#onTransitionFinished's overload set differs across
// Android 16 builds in the field (WindowContainerTransaction was added as a parameter at some
// point, and not every build agrees on which overload exists). This bridge tries each known
// overload via reflection (newest first) and only logs if all of them fail, instead of assuming
// one fixed signature.
